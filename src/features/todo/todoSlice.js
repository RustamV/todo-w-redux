...
export const todoSlice = createSlice({
  ...
  initialState: {
    value: [
      ...
      {id:2634279846328, date: "23.05.2020", todo: "Выбрать жизнь", status: "done"},
      {id:4368245439845, date: "24.05.2020", todo: "Выбрать работу", status: ""},
      {id:2635279842328, date: "25.05.2020", todo: "Выбрать карьеру", status: "done"},
      {id:4368725439845, date: "26.05.2020", todo: "Выбрать семью", status: ""},
    ],
  },
  reducers: {
